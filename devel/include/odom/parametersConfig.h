...
#ifndef __odom__PARAMETERSCONFIG_H__
#define __odom__PARAMETERSCONFIG_H__
  ...
  public:
    ...
    void setParams(parametersConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("odom_mode"==(*_i)->name){odom_mode = boost::any_cast<int>(val);}
        if("data_read"==(*_i)->name){data_read = boost::any_cast<int>(val);}
      }
    }
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.odom_mode = -2147483648;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.odom_mode = 2147483647;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.odom_mode = 0;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(parametersConfig::AbstractParamDescriptionConstPtr(new parametersConfig::ParamDescription<int>("odom_mode", "int", 0, "Odometry method", "{'enum_description': 'Enum of methods', 'enum': [{'srcline': 10, 'description': 'Euler odometry', 'srcfile': '/home/gulce/project1/src/odom/cfg/parameters.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Euler'}, {'srcline': 11, 'description': 'RK odometry', 'srcfile': '/home/gulce/project1/src/odom/cfg/parameters.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'RK'}]}", &parametersConfig::odom_mode)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(parametersConfig::AbstractParamDescriptionConstPtr(new parametersConfig::ParamDescription<int>("odom_mode", "int", 0, "Odometry method", "{'enum_description': 'Enum of methods', 'enum': [{'srcline': 10, 'description': 'Euler odometry', 'srcfile': '/home/gulce/project1/src/odom/cfg/parameters.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Euler'}, {'srcline': 11, 'description': 'RK odometry', 'srcfile': '/home/gulce/project1/src/odom/cfg/parameters.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'RK'}]}", &parametersConfig::odom_mode)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.data_read = -2147483648;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.data_read = 2147483647;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.data_read = 1;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(parametersConfig::AbstractParamDescriptionConstPtr(new parametersConfig::ParamDescription<int>("data_read", "int", 1, "Data for velocity calculation", "{'enum_description': 'Enum of data', 'enum': [{'srcline': 15, 'description': 'Velocity from ticks data', 'srcfile': '/home/gulce/project1/src/odom/cfg/parameters.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Ticks'}, {'srcline': 16, 'description': 'Velocity from angular speed data', 'srcfile': '/home/gulce/project1/src/odom/cfg/parameters.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'RPM'}]}", &parametersConfig::data_read)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(parametersConfig::AbstractParamDescriptionConstPtr(new parametersConfig::ParamDescription<int>("data_read", "int", 1, "Data for velocity calculation", "{'enum_description': 'Enum of data', 'enum': [{'srcline': 15, 'description': 'Velocity from ticks data', 'srcfile': '/home/gulce/project1/src/odom/cfg/parameters.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Ticks'}, {'srcline': 16, 'description': 'Velocity from angular speed data', 'srcfile': '/home/gulce/project1/src/odom/cfg/parameters.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'RPM'}]}", &parametersConfig::data_read)));
...
//#line 10 "/home/gulce/project1/src/odom/cfg/parameters.cfg"
      const int parameters_Euler = 0;
//#line 11 "/home/gulce/project1/src/odom/cfg/parameters.cfg"
      const int parameters_RK = 1;
//#line 15 "/home/gulce/project1/src/odom/cfg/parameters.cfg"
      const int parameters_Ticks = 0;
//#line 16 "/home/gulce/project1/src/odom/cfg/parameters.cfg"
      const int parameters_RPM = 1;
}
