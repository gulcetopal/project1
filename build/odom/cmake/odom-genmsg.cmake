...
message(STATUS "odom: 1 messages, 1 services")

set(MSG_I_FLAGS "-Iodom:/home/gulce/project1/src/odom/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/gulce/project1/src/odom/srv/reset_odom.srv" NAME_WE)
add_custom_target(_odom_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "odom" "/home/gulce/project1/src/odom/srv/reset_odom.srv" ""
)

get_filename_component(_filename "/home/gulce/project1/src/odom/msg/rpm.msg" NAME_WE)
add_custom_target(_odom_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "odom" "/home/gulce/project1/src/odom/msg/rpm.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(odom
  "/home/gulce/project1/src/odom/msg/rpm.msg"
  "${MSG_I_FLAGS}"
...
### Generating Services
_generate_srv_cpp(odom
  "/home/gulce/project1/src/odom/srv/reset_odom.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/odom
)
